...
protocol adjustFontSizeToFillRectProtocol {
    ...
    func adjustFontSizeToFillRect(_ newBounds: CGRect, view: HVKStickerView) -> Void
    func adjustsWidthToFillItsContens(_ view: HVKStickerView) -> Void
    
}

extension adjustFontSizeToFillRectProtocol {
    func adjustFontSizeToFillRect(_ newBounds: CGRect, view: HVKStickerView) {
    ...
    func adjustsWidthToFillItsContens(_ view: HVKStickerView) {
        guard let labelTextView = view.labelTextView else {
            return
        }
